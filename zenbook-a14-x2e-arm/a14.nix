...
in
{
  imports = [
    ./agent-sandbox.nix
    ./a14-power-governor.nix
    ./steam-arm64.nix
    ./helpers.nix
    # Temporary dock/suspend reset diagnostics, kept inline for replacement.
    ({ pkgs, ... }:
  ...
  # Fix USB and Audio power management issues. USB would have trouble waking up, and audio would suspend then not wake up
